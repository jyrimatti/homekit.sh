...
#! nix-shell -i dash -I channel:nixos-23.05-small -p dash nix fswatch nodejs yajsv parallel findutils coreutils gnused avahi python39 python3Packages.pycryptodome yq htmlq bc websocat flock getoptions ncurses curl sqlite "pkgs.callPackage ./jq-1.7.nix {}" "pkgs.callPackage ./accessories/stiebel/modbus_cli.nix {}"
. ./logging
. ./profiling
set -eu
